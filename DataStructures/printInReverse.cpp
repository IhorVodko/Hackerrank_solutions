// problem: https://www.hackerrank.com/challenges/print-the-elements-of-a-linked-list-in-reverse/problem?isFullScreen=true
...
void reversePrint(SinglyLinkedListNode * _list){
    using namespace std;
    if(!_list){
        return;
    }
    auto nums = vector<int>({_list->data});
    while(_list->next){
        _list = _list->next;
        nums.emplace_back(_list->data);
    };
