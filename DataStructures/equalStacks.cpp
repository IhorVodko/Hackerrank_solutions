...
int equalStacks(
        std::vector<int> const & _h1
    ,   std::vector<int> const & _h2
    ,   std::vector<int> const & _h3
){
    using namespace std;
    auto sum1 = accumulate(cbegin(_h1), cend(_h1), 0);
    auto sum2 = accumulate(cbegin(_h2), cend(_h2), 0);
    auto sum3 = accumulate(cbegin(_h3), cend(_h3), 0);
    auto it1 = begin(_h1);
    auto it2 = begin(_h2);
    auto it3 = begin(_h3);
